...
public:
    WebActionMapper(QAction *root, QUltralightPage::WebAction webAction, QObject *parent);
    QUltralightPage::WebAction webAction() const;
    void addChild(QAction *action);
    void updateCurrent(QUltralightPage *currentParent);
...
private:
    QUltralightPage *m_currentParent;
    QAction *m_root;
    QUltralightPage::WebAction m_webAction;
};
...
public:
    ...
    void clear();
    void addWebAction(QAction *action, QUltralightPage::WebAction webAction);
