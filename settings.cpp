...
void SettingsDialog::loadDefaults()
{
    ...
    enableJavascript->setChecked(defaultSettings->testAttribute(QUltralightSettings::JavascriptEnabled));
    enablePlugins->setChecked(defaultSettings->testAttribute(QUltralightSettings::PluginsEnabled));
}
